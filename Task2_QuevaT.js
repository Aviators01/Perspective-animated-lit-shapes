...
var FSHADER_SOURCE =
  ...
  'void main() {\n' +
  '  gl_FragColor = vec4(gl_FragCoord.x/u_Width,gl_FragCoord.y/u_Height,gl_FragCoord.y/u_Depth, 1.0);;\n' +
  '}\n';
...
function main() {
  ...
  mvpMatrix.lookAt(0, 0.75, 7.5, 0, 0, 0, 0, 1, 0);
...
function initVertexBuffers(gl) {
  ...
  var u_Depth = gl.getUniformLocation(gl.program, 'u_Depth');
  gl.uniform1f(u_Width, gl.drawingBufferWidth);
  gl.uniform1f(u_Height, gl.drawingBufferHeight);
  gl.uniform1f(u_Depth, gl.drawingBufferDepth);
